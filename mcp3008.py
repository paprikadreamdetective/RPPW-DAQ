...
class MCP3008:
    ...
    def __init__(self, spi, cs, ref_voltage=3.3):
        ...
        self._spi = spi
        self._out_buf = bytearray(3) # 0000 0000 0000 0000 0000 0000
        self._out_buf[0] = 0x01      # 0000 0000 0000 0000 0000 0001
        self._in_buf = bytearray(3)  # 0000 0000 0000 0000 0000 0000
    ...
    def read(self, pin, is_differential=False):
        ...
        self._out_buf[1] = ((not is_differential) << 7) | (pin << 4) # 0x80
        #print(self._out_buf)
